                    ...
                    if (err) {
                        ...
                        files.forEach(function (file) {
                            ...
                            if (path.extname(file)) {
                                addStr += '<li class="gray"><a href="' + filePath1 + '" style="">' + file + ' </a><a class="del" href="./?' + file + '">删除</a></li>';
                            } else {
                                addStr += '<li ><a href="' + filePath1 + '" style="">' + file + '</a><a class="del" onclick="removeP('+ filePath1 +')" href="./?">删除</a></li>';
                            }
                        });
                    }
